...
function Comments(){
    ...
    return(
        ...
        <div className="flex w-full h-full">
            ...
            <div className="container-comment flex flex-col gap-1.5 flex-1 w-full h-auto border-l-1 items-center overflow-y-scroll overflow-hidden">
                {comment.map((cmt) =>(
                    <div className="flex gap-3 border-1 rounded-lg px-2 py-2 w-[90%]">
                        ...
                        <div className="w-full">
                            <div className="w-full flex justify-between">
                                ...
                                <MoreHorizontal className="size-4 dark:text-white inline-block align-middle cursor-pointer"></MoreHorizontal>
                            </div>
                           ...
                           <div  className="flex gap-15 !text-gray-500">
                            <div className="flex gap-2 items-center text-sm ">
                             <Heart
                               className={`size-4 inline-block align-middle cursor-pointer transition-all duration-200 
                             hover:text-red-500 ${cmt.activated ? "fill-red-500 text-red-500" : "text-gray-500"}`}
                                onClick={() => {
